...
public class Main {
    public static void main(String[] args) {
        ...
        String plaintext = userInput.getUserInput("ENTER THE TEXT YOU WANT TO ENCRYPT:");

        EncryptionService encryptionService;

        System.out.println("SELECT ENCRYPTION METHOD (enter just the number):");
        System.out.println("-- 1 Caesar cipher");
        System.out.println("-- 2 Morse code");
        String choice = userInput.getUserInput("ENTER YOUR CHOICE:");
